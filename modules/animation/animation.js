    ...
    return {
        ...
        return deps('core.pure')(function(sys) {
          return function(app) {
            ...
            return [ grid.pure(), form.pure() ].lift(function(g, f, b) {
              ...
              sys.get('schema.$app').parse(app.schema, 3, true);
      ...
      ext: {
        ...
        initialize: function() {
          ...
          form.proxy('click', 'button', 'run');
          this.model('anim').form(form, { ms: 600, st: 20, rpt: 1, rows: 2, cols: 4, easing: 'swing' });
        }
      },
      control: {
        main: {
          animate: function() {
            ...
            var opts = form.get('data.main.attr').values(true);
